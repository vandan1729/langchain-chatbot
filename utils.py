...
def configure_llm():
    ...
    available_llms = ["gemini-2.0-flash", "llama-3.1-8b-instant", "llama-3.3-70b-versatile", "groq/compound", "deepseek-r1", "use your openai api key"]
    ...
    if llm_opt == "gemini-2.0-flash":
        llm = ChatGoogleGenerativeAI(
            model="gemini-2.0-flash",
            google_api_key=st.secrets["GOOGLE_API_KEY"],
            temperature=0
        )
    elif llm_opt == "llama-3.1-8b-instant":
        llm = ChatGroq(
            model="llama-3.1-8b-instant",
            groq_api_key=st.secrets["GROQ_API_KEY"],
            temperature=0
        )
    elif llm_opt == "llama-3.3-70b-versatile":
        llm = ChatGroq(
    ...
    elif llm_opt == "groq/compound":
        llm = ChatGroq(
            model="groq/compound",
            groq_api_key=st.secrets["GROQ_API_KEY"],
            temperature=0
        )
    elif llm_opt == "deepseek-r1":
        llm = ChatGroq(
