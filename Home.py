...
st.write("""
[![view source code ](https://img.shields.io/badge/GitHub%20Repository-gray?logo=github)](https://github.com/vandan1729/langchain-chatbot)
[![linkedin ](https://img.shields.io/badge/Vandan%20Patel-blue?logo=linkedin&color=gray)](https://www.linkedin.com/in/vandan1729/)
![Visitors](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2FDEPLOYED-APP-NAME.streamlit.app&label=Visitors&labelColor=%235d5d5d&countColor=%231e7ebf&style=flat)
""")
st.write("""
